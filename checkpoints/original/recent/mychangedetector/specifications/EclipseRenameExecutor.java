...
public class EclipseRenameExecutor extends Executor {
	...
	@Override
	public void afterRollback(final IEditorPart editor, final IDocument doc, IFile file) {
		...
		.addPostSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(
				...
				action.setCallback(resetCheckpointsCallback(doc,specification.getCheckpointName()));
				action.doRun();

				try {
					doc.replace(start_position, length,
							new_name.toString());
