	...
	public void createPartControl(Composite parent) {
		...
		reset.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				SampleBuilder.builder.resetCheckpoints();
		...
		ref.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				...
				List<String> segments = Arrays.asList(((Path)((File)input.getFile()).getFullPath()).segments());
		        List<String> relevant_path_segments = segments.subList(2,segments.size());
				...
				if(SampleBuilder.builder == null)
				{
					showMessage("Builder is null...");
					return;
				} 
				
				IResource current_resource = SampleBuilder.builder.getProject().getFile(name);
				
				SampleBuilder.builder.checkChanges(current_resource);
			}
		});
	...
	private void hookContextMenu() {
		...
		menuMgr.addMenuListener(new IMenuListener() {
			public void menuAboutToShow(IMenuManager manager) {
				RefactoringView.this.fillContextMenu(manager);
			}
		});
