...
import org.evolizer.changedistiller.distilling.AbstractRefactoringHelper;
import org.evolizer.changedistiller.distilling.ClassRefactoringHelper;
import org.evolizer.changedistiller.distilling.Distiller;
import org.evolizer.changedistiller.distilling.FieldRefactoringHelper;
import org.evolizer.changedistiller.distilling.MethodRefactoringHelper;
import org.evolizer.changedistiller.distilling.RefactoringCandidate;
import org.evolizer.changedistiller.distilling.RefactoringExtractor;
import org.evolizer.changedistiller.distilling.RefactoringPair;
 ...
 * 
 */
public class ExtendedDistiller extends Distiller {

    private static final String DOT = ".";

  //  private static final Logger LOGGER =
  //          ChangeDistillerPlugin.getLogManager().getLogger(Distiller.class.getCanonicalName());
    ...
    private List<ITreeEditOperation> script;
    ...
    public void performDistilling(IFile leftFile, IFile rightFile) {
        ...
        if (diff != null) {
            ...
            script = new LinkedList<ITreeEditOperation>();
